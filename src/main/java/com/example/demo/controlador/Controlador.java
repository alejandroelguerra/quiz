...
//CREACION PREGUNTA 1
	...
	public String pregunta1_post(Model model, HttpServletRequest request, @RequestParam String p1) {
...
//CREACION PREGUNTA 2
	...
	public String pregunta2_post(Model model, HttpServletRequest request, @RequestParam String p2) {
		@SuppressWarnings("unchecked")
		List<String> messages = (List<String>) request.getSession().getAttribute("RESPUESTA");
		if (messages == null) {
			messages = new ArrayList<>();
...
//CREACION PREGUNTA 3
	...
	public String pregunta3_post(Model model, HttpServletRequest request,
			@RequestParam(defaultValue = "false") Boolean p3_a, @RequestParam(defaultValue = "false") Boolean p3_b,
			@RequestParam(defaultValue = "false") Boolean p3_c, @RequestParam(defaultValue = "false") Boolean p3_d) {

		if (p3_a == false && p3_b == false && p3_c == false && p3_d == false) {
			return "redirect:/pregunta3";
		}
		if (p3_a == true && p3_b == true && p3_c == true && p3_d == true) {
			return "redirect:/pregunta3";
		}
		if (p3_a == true && p3_b == true && p3_c == true && p3_d == false) {
			return "redirect:/pregunta3";
		}
		if (p3_a == true && p3_b == true && p3_c == false && p3_d == true) {
			return "redirect:/pregunta3";
		}
		if (p3_a == true && p3_b == false && p3_c == true && p3_d == true) {
			return "redirect:/pregunta3";
		}
		if (p3_a == false && p3_b == true && p3_c == true && p3_d == true) {
			return "redirect:/pregunta3";
		}
		if (p3_b == true) {
			@SuppressWarnings("unchecked")
...
//CREACION PREGUNTA 4
	...
	public String pregunta4_post(Model model, HttpServletRequest request, @RequestParam String p4) {
		@SuppressWarnings("unchecked")
		List<String> messages = (List<String>) request.getSession().getAttribute("RESPUESTA");
		if (messages == null) {
			messages = new ArrayList<>();
...
//CREACION PREGUNTA 5
	...
	public String pregunta5_post(Model model, HttpServletRequest request, @RequestParam String p5) {
		@SuppressWarnings("unchecked")
		List<String> messages = (List<String>) request.getSession().getAttribute("RESPUESTA");
		if (messages == null) {
			messages = new ArrayList<>();
...
//CREACION PREGUNTA 6
	...
	public String pregunta6_post(Model model, HttpServletRequest request, @RequestParam String p6) {
		
		if (p6=="") {
			return "redirect:/pregunta6";
		}
		if (p6.equals("Dev1ce")|| p6.equals("dev1ce")) {
			@SuppressWarnings("unchecked")
			List<String> messages = (List<String>) request.getSession().getAttribute("RESPUESTA");
			if (messages == null) {
				messages = new ArrayList<>();
...
//CREACION PREGUNTA 7
	...
	public String pregunta7_post(Model model, HttpServletRequest request, @RequestParam String p7) {
		@SuppressWarnings("unchecked")
		List<String> messages = (List<String>) request.getSession().getAttribute("RESPUESTA");
		if (messages == null) {
			messages = new ArrayList<>();
